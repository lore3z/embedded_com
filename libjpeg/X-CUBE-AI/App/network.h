...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "hrnetlite18_lite_40_new_rgb"
...
#define AI_NETWORK_IN_1_HEIGHT      (40)
#define AI_NETWORK_IN_1_WIDTH       (40)
#define AI_NETWORK_IN_1_CHANNEL     (3)
#define AI_NETWORK_IN_1_SIZE        (4800)
#define AI_NETWORK_IN_1_SIZE_BYTES  (19200)
